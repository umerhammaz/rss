...
class WpAutomaticCareerjet extends wp_automatic
{
	...
	function careerjet_fetch_items($keyword, $camp)
	{
		...
		//if cg_cj_locale_custom is set and is not empty, overwrite the locale_code with the location
		if(isset ($camp_general['cg_cj_locale_custom']) && wp_automatic_trim($camp_general['cg_cj_locale_custom']) != ''){
			echo '<br>Overwriting locale_code with:' . $camp_general['cg_cj_locale_custom'];
			$cg_cj_locale = wp_automatic_trim($camp_general['cg_cj_locale_custom']);
		} 
