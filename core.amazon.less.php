		...
		foreach ( $keywords as $keyword ) {
			...
			if (wp_automatic_trim( $keyword ) != '') {
				...
				if (count ( $res ) > 0) {
					...
					//product_summary
					if(isset($item['product_summary'])) $temp['product_summary'] = $item['product_summary'];

					//product_reviews_text
					if(isset($item['product_reviews_text'])) $temp['product_reviews_text'] = $item['product_reviews_text'];
					
					//product_reviews
					if(isset($item['product_reviews'])) $temp['product_reviews'] = $item['product_reviews'];
