...
//replace double quotes by quote fix:22891
$_POST['camp_keywords'] = wp_automatic_str_replace('"', "ʼ", $_POST['camp_keywords'] );
$_POST['camp_keywords'] = wp_automatic_str_replace("\ʼ", "ʼ", $_POST['camp_keywords'] );
...
if ( (wp_automatic_trim($camp_keywords) == '' && !( $camp_type =='Feeds' ||  $camp_type =='Spintax' ||  $camp_type =='Facebook' || $camp_type =='Craigslist' || $camp_type =='Reddit' || $camp_type =='Single' || $camp_type =='Multi' || $camp_type =='telegram' || $camp_type =='GoogleNews' || $camp_type =='Rumble' || $camp_type =='Places'  ) )  || ($camp_type == 'Feeds' && wp_automatic_trim($feeds) == '') || ($camp_type == 'GoogleNews' && wp_automatic_trim($feeds) == '')   ) return false;
